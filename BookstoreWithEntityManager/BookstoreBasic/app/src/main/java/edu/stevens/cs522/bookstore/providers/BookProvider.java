...
public class BookProvider extends ContentProvider {
    ...
    //uri match part
    private static final int ALLBOOKS = 10000;
    private static final int ONEBOOK = 10001;
    private static final int ALLAUTHORS = 10002;
    private static final int ONEAUTHOR = 10003;
    ...
    public Cursor query(Uri uri, String[] projection, String where,String[] whereArgs, String sort) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case ONEBOOK:
                ...
                cursor = cartDbAdapter.getBook(rowId);
                break;
            default:
